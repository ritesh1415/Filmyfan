...
const Login = () => {
  ...
  const login = async () => {
    setLoading(true);
    let isUserFound = false; // Initialize a flag variable
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        if (isUser) {
          ...
          navigate('/');
          isUserFound = true; // Set the flag to true for successful login
        }
      })
  
      // Check the flag and show the appropriate SweetAlert
      if (!isUserFound) {
        swal({
